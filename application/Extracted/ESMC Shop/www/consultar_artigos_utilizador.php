<html>
	...
	<body>
		<?php
			...
			$query2 = "SELECT * from artigos, utilizadores, categorias where artigos.nome_utilizador='$nome_utilizador' and artigos.nome_utilizador=utilizadores.nome_utilizador and categorias.id_categoria=artigos.id_categoria";
			$res2=mysql_query($query2);
			$num_rows2 = mysql_num_rows($res2);
			$query3 = "SELECT * from artigos, licitacoes where licitacoes.nome_utilizador='$nome_utilizador' and artigos.id_artigo=licitacoes.id_artigo group by licitacoes.id_artigo";
