		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Parab&eacute;ns! Acabou de adquirir um artigo!</h3>
						<ul class="sectionList">
							<li>
								<b>Acabou de adquirir um artigo. Muitos parab&eacute;ns!</b>
								<br>
								<br>
								Por este mesmo motivo, o lei&atilde;o que estava a ocorrer por este artigo, encontra-se neste momento terminado.
								<br>
								<br>
								Como j&aacute; avaliou este artigo e o nosso servi&ccedil;o, n&atilde;o o pode fazer novamente.
								<br>
								<br>
								Pode voltar &agrave sua p&aacutegina inicial <b><a href='index_utilizador.php'>aqui</a>.</b>
                       	    </li>
						</ul>
					</div>
				</div>
