		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Erro! Os dados para actualizar o seu artigo para leil&atildeo est&atildeo errados.</h3>
						<ul class="sectionList">
							<li>
							<?php
								echo "<b>Os dados do seu artigo para leil&atildeo n&atildeo foram adicionados &agrave nossa base de dados. Pedimos desculpa pelo inc&oacutemodo.</b>";
								echo "<br>";
								echo "<br>";
								echo "<b>Verifique tamb&eacutem se a <i>hora e data limite do leil&atildeo</i> s&atildeo posteriores &agraves actuais.</b>";
								echo "<br>";
								echo "<br>";
								echo "Pode voltar a consultar os seus artigos para leil&atildeo para poder alterar os seus dados posteriormente <b><a href='consultar_artigos_utilizador.php?nome_utilizador=" . $row1['nome_utilizador']. "'>aqui</a>.</b>";
                       	    ?>
							</li>
						</ul>
					</div>
