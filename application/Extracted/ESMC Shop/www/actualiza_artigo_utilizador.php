<html>
    ...
    <body>
		<?php
			...
			$query2 = "SELECT * from artigos, utilizadores, categorias where artigos.id_artigo='$id_artigo' and artigos.nome_utilizador='" . $_SESSION["nome_utilizador"] . "' and artigos.nome_utilizador = utilizadores.nome_utilizador and artigos.id_categoria=categorias.id_categoria";
