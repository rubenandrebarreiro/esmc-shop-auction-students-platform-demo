<html>
	...
	<script language="javascript">
		function test_avaliacao_artigo_servico()
		{
			...
			{
				alert ("Tem que seleccionar uma AVALIACAO DO SERVIÇO");
				return false;
			}
			return true;
		}
		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Parab&ecutens! Acabou de adquirir um artigo!</h3>
						<ul class="sectionList">
							<li>
								<b>Acabou de adquirir um artigo. Muitos parab&ecute;ns!</b>
								<br>
								<br>
								Por este mesmo motivo, o lei&atilde;o que estava a ocorrer por este artigo, encontra-se neste momento terminado.
								<br>
								<br>
								Agora pode avaliar o artigo que adquiriu e o nosso servi&ccedil;o.
								<br>
								<br>
