<html>
	...
	<?php
		...
		$res1 = mysqli_query($con, "SELECT * from artigos, licitacoes where artigos.id_artigo=licitacoes.id_artigo group by artigos.id_artigo order by count(licitacoes.id_licitacao) desc");
		$res2 = mysqli_query($con, "SELECT * from artigos order by id_artigo desc");
	?>
		<div id="outer">
			<div id="header">
				<div id="logo">
