...
<html>
	...
	<body>
		<?php
			...
			$res1 = mysqli_query($con, "SELECT * from artigos, categorias WHERE artigos.nome_artigo like '%$nome_artigo%' AND artigos.condicao_artigo LIKE '%$condicao_artigo%' AND artigos.data_limite <= '$data_limite' AND artigos.forma_pagamento LIKE '%$forma_pagamento%' AND artigos.nome_utilizador LIKE '%$nome_utilizador%' AND categorias.nome_categoria LIKE '%$categoria%' AND artigos.id_categoria=categorias.id_categoria");
