		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Acabou de actualizar um artigo para leil&atildeo!</h3>
						<ul class="sectionList">
							<li>
							<?php
								echo "<b>Os dados do seu artigo para leiloar foram actualizados na nossa base de dados.</b>";
								echo "<br>";
								echo "<br>";
								echo "Pode voltar a consultar os seus artigos para leil&atildeo <b><a href='consultar_artigos_utilizador.php?nome_utilizador=" . $row1['nome_utilizador']. "'>aqui</a>.</b>";
								echo "<br>";
								echo "<br>";
								echo "Pode voltar &agrave sua p&aacutegina inicial <b><a href='index_utilizador.php'>aqui</a>.</b>";
                       	    ?>
							</li>
						</ul>
					</div>
