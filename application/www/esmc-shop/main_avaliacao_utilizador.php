		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Obrigado por ter avaliado o artigo e o nosso servi&ccedil;o!</h3>
						<ul class="sectionList">
							<li>
								<b>Obrigado por ter avaliado o artigo e o nosso servi&ccedil;o! Esperamos que tenha gostado.</b>
								<br>
								<br>
