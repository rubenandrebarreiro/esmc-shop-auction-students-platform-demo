						...
						<ul class="sectionList">
							<?php
								...
								echo "<li>";
									...
									{	
										if ($row2['nome_utilizador'] == $_SESSION['nome_utilizador'])
										{
											echo "<font id='sugestoes'><b>Este leil&atilde;o ainda est&aacute; a decorrer</b></font>";
											echo "<br>";
											echo "<br>";
											echo "<a href='historico_licitacoes_artigo_utilizador.php?id_artigo=" . $row2['id_artigo'] . "'>&raquo;&nbsp;Ver o hist&oacute;rico de licita&ccedil;&otilde;es pelo meu artigo</a>";
											echo "<br>";
											echo "<a href='actualiza_artigo_utilizador.php?id_artigo=" . $row2['id_artigo'] . "'>&raquo;&nbsp;Alterar os dados do meu artigo para leil&atilde;o</a>";
											echo "<br>";
											echo "<a href='terminar_leilao_utilizador.php?id_artigo=" . $row2['id_artigo'] . "'>&raquo;&nbsp;Terminar leil&atilde;o pelo meu artigo</a>";
											echo "<br>";
											echo "<a href='remover_artigo_utilizador.php?id_artigo=" . $row2['id_artigo'] . "'>&raquo;&nbsp;Remover o meu artigo para leil&atilde;o</a>";
										}
										if ($row2['nome_utilizador'] != $_SESSION['nome_utilizador'])
										{
											echo "<font id='sugestoes'><b>Este leil&atilde;o ainda est&aacute; a decorrer</b></font>";
											echo "<br>";
											echo "<br>";
											echo "<a href='historico_licitacoes_artigo_utilizador.php?id_artigo=" . $row2['id_artigo'] . "'>&raquo;&nbsp;Ver o hist&oacute;rico de licita&ccedil;&otilde;es por este artigo</a>";
											echo "<br>";
											echo "<a href='licitacao_artigo_utilizador.php?id_artigo=" . $row2['id_artigo'] . "'>&raquo;&nbsp;Fazer uma licita&ccedil&atilde;o por este artigo</a>";
										}
									}
									else
									{	
