		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Erro! Os dados do seu artigo para leil&atildeo est&atildeo errados.</h3>
						<ul class="sectionList">
							<li>
								<b>Os dados do seu artigo para leil&atildeo n&atildeo foram adicionados &agrave nossa base de dados. Pedimos desculpa pelo inc&oacutemodo.</b>
								<br>
								<br>
								<b>Verifique se o ficheiro que carregou para a <i>Foto do Artigo</i> tem a extens&atilde;o .JPG ou .BMP e se tem menos de 2 MB.</b>
								<br>
								<br>
								<b>Verifique tamb&eacutem se a <i>hora e data limite do leil&atildeo</i> s&atildeo posteriores &agraves actuais.</b>
								<br>
								<br>
								Pode voltar a tentar adicionar um artigo para leil&atildeo <b><a href='registo_artigos_utilizador.php'>aqui</a>.</b>
                       	    </li>
						</ul>
					</div>
				</div>
