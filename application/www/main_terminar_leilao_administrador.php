		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Acabou de terminar um leil&atilde;o</h3>
						<ul class="sectionList">
							<li>
                           		<b>Acabou de terminar um leil&atilde;o. Os utilizadores n&atilde;o poder&atilde;o voltar a fazer licita&ccedil;&otilde;es por este artigo e o utilizador que fez a licita&ccedil;&atilde;o mais alta, vai adquirir o artigo.</b>
								<br>
								<br>
								Pode voltar &agrave sua p&aacutegina inicial <b><a href='index_administrador.php'>aqui</a>.</b>
                       	    </li>
						</ul>
					</div>
				</div>
