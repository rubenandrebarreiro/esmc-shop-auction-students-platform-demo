		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Erro! Os seus dados n&atildeo foram actualizados.</h3>
						<ul class="sectionList">
							<li>
								<?php
									echo "<b>Os seus dados n&atildeo foram actualizados na nossa base de dados. Pedimos desculpa pelo inc&oacutemodo.</b>";
									echo "<br>";
									echo "<br>";
									echo "Pode voltar a actualizar os seus dados <b><a href='actualiza_registo_administrador.php?nome_utilizador=" . $row1['nome_utilizador'] . "'>aqui</a>.</b>";
								?>
                       	    </li>
						</ul>
					</div>
