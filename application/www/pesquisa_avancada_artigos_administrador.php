				...
				<div id="content">
					...
					<div id="box4">
						...
						<ul class="sectionList">
							<li>
								<form name="form_pesquisa_avancada_artigos" method="post" action="resultado_pesquisa_avancada_artigos_administrador.php" onSubmit="return test_pesquisa_avancada_artigos();">
