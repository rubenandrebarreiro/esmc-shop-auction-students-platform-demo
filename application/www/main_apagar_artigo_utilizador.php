		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Acabou de remover o artigo que tinha para leil&atildeo!</h3>
						<ul class="sectionList">
							<li>
								<b>Os dados do seu artigo para leiloar j&aacute n&atildeo existem na nossa base de dados.</b>
								<br>
								<br>
								Pode voltar a adicionar mais artigos para leil&atildeo <b><a href='registo_artigos_utilizador.php'>aqui</a>.</b>
								<br>
								<br>
