<html>
	...
	<body>
		<?php
			...
			$query="UPDATE utilizadores SET nome_proprio='$nome_proprio', apelido='$apelido',
			...
			if (!$res)
			{
				include("erro_actualiza_registo_administrador.php");
			}
			else
			{   
				include("main_actualiza_registo_administrador.php");
			}
		?>
	</body>
</html>