<html>
	...
	<body>
		<?php
			...
			$query2 = "SELECT * from artigos, categorias where artigos.nome_artigo like '%$nome_artigo%' and artigos.condicao_artigo like '%$condicao_artigo%' and artigos.data_limite <= '$data_limite' and artigos.forma_pagamento like '%$forma_pagamento%' and artigos.nome_utilizador like '%$nome_utilizador%' and categorias.nome_categoria like '%$categoria%' and artigos.id_categoria=categorias.id_categoria";
