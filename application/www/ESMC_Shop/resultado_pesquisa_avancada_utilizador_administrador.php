<html>
	...
	<body>
		<?php
			...
			$turma=$_POST["turma"];
			$query2 = "SELECT * from utilizadores where turma like '%$turma%' and ano like '%$ano_escolaridade%' and apelido like '%$apelido%' and nome_proprio like '%$nome_proprio%' and nome_utilizador like '%$nome_utilizador%'";
