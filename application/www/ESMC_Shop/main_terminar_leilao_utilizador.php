		...
		<div id="outer">
			...
			<div id="main">
				<div id="content">
					...
					<div id="box4">
						<h3>Acabou de terminar o leil&atilde;o pelo seu artigo</h3>
						<ul class="sectionList">
							<li>
                           		<b>Acabou de terminar o leil&atilde;o pelo seu artigo. Os outros utilizadores n&atilde;o poder&atilde;o voltar a fazer licita&ccedil;&otilde;es pelo seu artigo e o utilizador que fez a licita&ccedil;&atilde;o mais alta, vai adquirir o artigo.</b>
								<br>
								<br>
