<html>
	...
	<script language="javascript">
		function test_registo_artigos()
		{
			...
			{
				alert ("O campo PREÇO FINAL esta invalido");
				return false;
			}
    ...
    <body>
		<?php
			...
			$lig=mysql_connect("localhost","root","") or die("Erro na conexÃ£o");
							...
							<li>
                           		<form enctype="multipart/form-data" name="form_registo_artigos" method="post" action="processar_registo_artigos_utilizador.php" onSubmit="return test_registo_artigos();">
									...
									<p>
										...
										<input type="file" class="file_input_hidden" name="foto_artigo_hidden" onchange="javascript: document.getElementById('foto_artigo').value = this.value">
										</div>
									</p>
									<p>
